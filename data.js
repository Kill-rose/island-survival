...
function createButton(label) {
  ...
  let description = commandDescriptions[label] || commandDescriptions[label.replace(/[🔍🗺⏳🔥🪵🛶🔨⚔🪧⬇⬆🚪⏸👊🍖]/g, '').trim()];
  button.attribute('title', description || 'この操作を実行します。');
  button.mousePressed(() => {
    if (button.elt.dataset.sfx !== 'none') playSfx('select');
  });
  return button;
}
...
const itemDescriptions = {
  ...
  '肉と薬草の包み': '狼肉と薬草を包んだ保存食。体力と気力を同時に回復する。<br>【体力 +15 / 気力 +15】',
  ...
  '焚火':     '広場に設置して休憩できる焚火。燃料を入れると長く使える。',
  'いかだ':   '木材と紐で作ったいかだ。広場に設置して脱出に使う。',
  ...
  '焼きうさぎ': '火を通したうさぎ肉。生肉より食べやすく、体力と気力が回復する。<br>【体力 +20 / 気力 +20】',
  '焼き狼肉': '香ばしく焼いた狼肉。大きく体力と気力が回復する。<br>【体力 +30 / 気力 +25】',
  '焼き果実': '焚火で温めた果実。気力が少し回復する。<br>【体力 +5 / 気力 +15】',
  '焼きりんご': '甘い香りの焼きりんご。体力と気力が回復する。<br>【体力 +10 / 気力 +15】',
...
const commandDescriptions = {
  '探索': '現在地を調べ、アイテムや敵を見つけます。',
  '移動': '広場・森・洞窟、または研究所内を移動します。',
  '待機': '時間を1時間進めます。焚火があれば回復します。',
  '前進': '探索を進めるため、敵との戦闘を開始します。',
  '後退': '戦闘中は距離を取り、通常時は浅い層へ戻ります。',
  '逃走': '戦闘から逃げ、到達済みの浅い層へ戻ります。',
  '制作': '広場で材料から道具や食料を作ります。',
  'いかだ': '設置したいかだで脱出を試みます。',
  '燃料投入': '木の枝や木材を焚火にくべます。',
  '探索': '現在地を調べ、アイテムや敵を見つけます。',
  '使用': '選択したアイテムを使います。',
  '説明': '選択したアイテムの説明を表示します。',
  '観察': '戦闘中の敵の射程や攻略ヒントを確認します。',
  'アイテム': '戦闘中に回復アイテムを使います。',
  '投げる': '戦闘中、アイテムを敵に投げて隙を作ります。',
  '会話': 'ケイと会話し、手がかりを得ます。',
};
...
let campfireHours = 0; // 焚き火が点いてからの経過時間（24時間で燃料1消費）
let hasRaft = false;
...
const enemyTypes = {
  ...
  'コカトリス': {
    ...
    desc: '鶏の体に蛇の尾を持つ怪物。鋭い爪とくちばしで襲いかかり、赤い目でこちらを見据えている。',
    atkDesc: ['鋭いくちばしで突いた', '爪で引っかいた', '翼を広げて体当たりした'],
    drops: [
  ...
  '魚（変異体）': {
    ...
    desc: '研究所で作られた魚の変異体。濁った水の匂いをまとい、大きな口を開けて突進してくる。食べ物を与えると動きが鈍くなる。',
    atkDesc: ['大きな口で噛みついた', '尾びれで叩いた', '勢いよく突進した'],
    drops: [
      { item: '骨', chance: 0.7 },
      { item: '毒の牙', chance: 0.3 },
    ],
...
// =====================
const monsterImages = {
  'コカトリス':       'monster/kokatorisu.png',
  'おおかみ':         'monster/ookami.png',
  'コウモリ':         'monster/koumori.png',
  'リス（狙撃型）':   'monster/risu.png',
  '岩トカゲ':         'monster/tokage.png',
  '毒ヘビ':           'monster/hebi.png',
  '変異ヤマアラシ':   'monster/tokage.png',
  'ウミウシ（変異体）':'monster/sakana.png',
  '魚（変異体）':     'monster/sakana.png',
  'タコ（変異体）':   'monster/sakana.png',
